...
(function($){
 $.fn.airtimeShowSchedule = function(options) {
    ...
    var defaults = {
        ...
        sourceDomain: "https://admin.boosh.fm/", //where to get show status from
...
(function($){
 $.fn.airtimeWeekSchedule = function(options) {
    ...
    var defaults = {
        ...
        miscText: {time:"Time (UTC)", programName:"Program Name", details:"Details", readMore:"Show Profile"}
    };
    options = $.extend(true, defaults, options);
    options.sourceDomain = addEndingBackslash(options.sourceDomain);
